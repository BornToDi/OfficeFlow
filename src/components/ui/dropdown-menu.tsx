...
/* ------------------------------------------------------------------
   Helpers for links / common items
-------------------------------------------------------------------*/

/** Use this to create a menu item that navigates with Next.js Link. */
...
/** Ready-made Settings item linking to /settings with icon. */
function DropdownMenuSettingsItem({ href = "/settings" }: { href?: string }) {
  return (
