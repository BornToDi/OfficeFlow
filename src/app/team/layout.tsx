...
import {
  SidebarProvider, Sidebar, SidebarMenu, SidebarMenuItem,
      ...
      <Sidebar>
        ...
        <SidebarContent>
          ...
          <SidebarMenu>
            ...
            <SidebarMenuItem><Link href="/bills" className="flex h-8 items-center gap-2 rounded-md px-2 text-sm hover:bg-sidebar-accent hover:text-sidebar-accent-foreground"><FileText />Bills</Link></SidebarMenuItem>
            ...
            <SidebarMenuItem><Link href="/team" className="flex h-8 items-center gap-2 rounded-md px-2 text-sm bg-sidebar-accent text-sidebar-accent-foreground"><Users />All Employee</Link></SidebarMenuItem>
          </SidebarMenu>
        </SidebarContent>
        <SidebarFooter>
          <SidebarMenu>
